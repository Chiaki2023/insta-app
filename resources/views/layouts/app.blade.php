        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <!-- Left Side Of Navbar -->
                    {{-- Search bar. Show only to the logged in user --}}
                    @auth
                        @if (!request()->is('admin/*'))
                            <ul class="navbar-nav ms-auto border">
                                <form action="{{ route('search') }}" style="width: 300px;">
                                <input type="search" name="search" placeholder="Search..." class="form-control form-control-sm"></form>
                            </ul>
                        @endif
                    @endauth
                    ...
                    @if (request()->is('admin/*'))
                        <div class="col-3">
                           <div class="list-group">
                            {{-- Users --}}
                            <a href="{{ route('admin.users') }}" class="list-group-item {{ request()->is('admin/users') || request()->is('admin/users/people')? 'active' : '' }}">
